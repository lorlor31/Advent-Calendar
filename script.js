...
for(let i in tableauCartes) {
    ...
    function ouvertureFenetre(){
        ...
        let dateDuJour=new Date
            numeroDuJour=dateDuJour.getDate()
        function montrerElementsCaches(){
            popup.classList.toggle("show");
            gingerman.classList.toggle("afficheGinger");
            popup.style.visibility="hidden";
            gingerman.style.visibility="hidden";
            // afficheGinger.classList.toggle("gingerman");
        ...
        if (superUValue==true) {montrerElementsCaches()} 
            ...
            if (chiffreClique==numeroDuJour) {
                ...
                gingerman.classList.toggle("afficheGingerError");
